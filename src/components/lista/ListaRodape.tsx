    ...
    function renderizarBotoesFiltro() {
        return (<>
            ...
            <ListaBotao
                ...
                onClick={() => mudou(tarefas.filtrarCocluidas())}

            >Concluidas</ListaBotao>
        </>)
    }
    function renderizarExcluirConcluidas() {
        return (
            ...
            <span className="flex-grow"></span>
                <ListaBotao onClick={() => mudou(tarefas.excluirConcluidas())} >Excluir <span className="hidden md:inline"> Concluidas</span></ListaBotao>
            </>
        )
    }

    return (
        <li className="flex p-5 text-gray-500">
