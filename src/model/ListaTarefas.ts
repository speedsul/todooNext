...
export default class ListaTarefas {
    ...
    constructor(todas: Tarefa[], filtroUtilizado = TipoFiltro.NEHUM) {
        this.#todas = todas
        this.#filtroUtilizado = filtroUtilizado ?? TipoFiltro.NEHUM
    }
    ...
    excluirConcluidas(): ListaTarefas {
        ...
        return new ListaTarefas(somenteAtivas, TipoFiltro.NEHUM)
    }
    filtrarCocluidas(): ListaTarefas {
    ...
    removerFiltro(): ListaTarefas {
        if (!this.exibindoTodas()) {
            return new ListaTarefas(this.#todas, TipoFiltro.NEHUM)
        } else {
            return this
        }
    ...
    exibindoTodas(): boolean {
        return this.#filtroUtilizado === TipoFiltro.NEHUM
    }
